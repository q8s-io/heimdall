...
func NewJobAnchore(jobAnchoreData entity.JobAnchoreData) {
...
func GetJobAnchore(taskID string) *[]entity.JobAnchoreData {
	execSQL := fmt.Sprintf("SELECT task_id, job_id, job_status, job_data FROM job_anchore WHERE task_id='%s'",
		taskID)
	jobAnchoreDataList := new([]entity.JobAnchoreData)
...
func UpdateJobAnchore(jobAnchoreData entity.JobAnchoreData) {
...
func SendJobAnchoreMsg(jobAnchoreMsg *entity.JobAnchoreMsg) {
